  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-6 max-w-xl sm:mx-auto m-5">
        {/* Question 1 */}
        <Card>
          <CardHeader>
                ...
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      ...
                      <div key="excellent" className="flex items-center gap-3">
                ...
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      ...
                      <div key="energized" className="flex items-center gap-3">
                ...
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      ...
                      <div key="countless" className="flex items-center gap-3">
