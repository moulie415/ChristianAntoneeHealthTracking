  ...
  return (
    <Form {...form}>
      <form
        ...
        <Card>
          <CardHeader>
            <FormLabel> 2. What were your top stress triggers today?</FormLabel>
          </CardHeader>
          <CardContent className="space-y-2">
            <FormField
              control={form.control}
        ...
        <Card>
          <CardHeader>
            <FormLabel> 4. What helped you manage your stress today?</FormLabel>
          </CardHeader>
          <CardContent className="space-y-2">
            <FormField
              control={form.control}
                ...
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      ...
                      defaultValue={field.value}
                      className="space-y-2">
                      <FormItem key="worse" className="flex items-center gap-3">
                        <RadioGroupItem value="worse" />
                        <Label htmlFor="worse"> Yes — made it worse</Label>
                      </FormItem>
                      <FormItem key="tense" className="flex items-center gap-3">
                      ...
                      <FormItem
                        ...
                        <Label htmlFor="no_impact">No noticeable impact</Label>
                      </FormItem>
                      <FormItem
                        key="helped_distract"
                        className="flex items-center gap-3">
                ...
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      ...
                      defaultValue={field.value}
                      className="space-y-2">
                      <FormItem key="aware" className="flex items-center gap-3">
